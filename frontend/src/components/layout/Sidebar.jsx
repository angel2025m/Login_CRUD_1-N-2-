...
import { Home, User, LogOut, Store, FileChartColumn, CloudUpload } from 'lucide-react';
...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { id: 'compra', path: '/store', icon: Store, label: 'Productos'},
    { id: 'reporte', path: '/reporte', icon: FileChartColumn, label: 'Reportes'},
  ];
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <button
            ...
            className="w-full mt-2 flex items-center justify-center space-x-2 px-4 py-2.5 rounded-lg transition-all font-medium text-sm text-white hover:opacity-90"
            style={{ backgroundColor: colors.primary }}
          >
            <LogOut size={18} />
